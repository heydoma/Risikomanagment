...
\subsection{Risikoregister mit Status-Historie}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{3.0cm}>{\raggedright\arraybackslash}p{3.4cm}>{\raggedright\arraybackslash}p{1.1cm}>{\raggedright\arraybackslash}p{3.4cm}>{\raggedright\arraybackslash}p{3.2cm}@{}}
\toprule
\textbf{Risiko} & \textbf{KRI / Trigger} & \textbf{E\,/\,A} & \textbf{Status-Historie} & \textbf{Maßnahmen / Owner} \\
\midrule
\endfirsthead
\multicolumn{5}{l}{\footnotesize\textit{SafeLend-Risikoregister (Fortsetzung)}}\\
\toprule
\textbf{Risiko} & \textbf{KRI / Trigger} & \textbf{E\,/\,A} & \textbf{Status-Historie} & \textbf{Maßnahmen / Owner} \\
\midrule
\endhead
...
& Doku\-men\-ta\-tions\-voll\-stän\-dig\-keit der Governance-Artefakte = 100\%
& 5\,/\,6
...
& Pflicht\-feld\-voll\-stän\-dig\-keit $\geq$ 98\%, Ab\-leh\-nungs\-quo\-ten-Dif\-fe\-renz $\leq$ 5\%
& 6\,/\,10
...
Unklare Verantwortlichkeiten in der Freigabe
& Offene Freigabepunkte = 0; alle Rollen zugewiesen
& 4\,/\,6
& Phase 1: Grün (passiv) \textrightarrow{} Phase 2--5: Grün (passiv)
& Keine Maßnahme; passiv beobachtet / Projektleitung \\

Geringe Erklärbarkeit kritischer Entscheidungen
& SHAP-/LIME-Analyse je Entscheidungsklasse verfügbar
& 4\,/\,5
& Phase 3: Grün (passiv) \textrightarrow{} Phase 4--5: Grün (passiv)
& Keine Maßnahme; passiv beobachtet / Data Science \\

Schnittstellenfehler in der Ende-zu-Ende-Kette
& Schnittstellenfehlerquote $< 1\%$
& 4\,/\,5
& Phase 4: Grün (passiv) \textrightarrow{} Phase 5: Grün (passiv)
& Keine Maßnahme; passiv beobachtet / IT \\

\caption{SafeLend-Risikoregister mit Status-Historie, eigene Darstellung}
