...
\begin{center}
    \begin{table}[H]
        \begin{tabular}{|p{2.5cm}|p{4.9cm}|p{2.5cm}|p{4.9cm}|}
            ...
            \hline
            Monte-Carlo-Simulation & Mathematische Technik, um Unsicherheiten in Vorhersagen einbeziehen zu können & NIST AI Risk Management Framework  & US Standard für das Management von KI-Risiken\\
            \hline
        \end{tabular}
