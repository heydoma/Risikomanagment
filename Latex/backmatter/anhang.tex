...
\section{Dokumentation der Arbeitsaufteilung}
\begin{center}

\begin{tabular}{|p{3cm}|p{4.9cm}|p{3cm}|p{4.9cm}|p{3cm}}
    \hline
    \textbf{Bearbeitetes Kapitel} & \textbf{Grundlegende Idee} & \textbf{Texterstellung} & \textbf{Textkorrektur} & \textbf{Visualisierung}} \\
    \hline
