...
\begin{itemize}
  ...
  \item \textbf{Compliance-Governance im Sinne von \enquote{by Design}:}
...
Trotz geteilter Rollen muss die Rechenschaftspflicht klar sein. Accountability bedeutet, dass Organisationen Verantwortliche und Nachweisbarkeit über Entscheidungen, Datenstände und Modellversionen festlegen \cite{FloridiCowls2019}.

Zur strukturellen Verankerung dieser Trennung unterscheidet COBIT
Governance (evaluate, direct and monitor) von Management (plan, build, run and monitor)
und liefert damit eine praxisnahe Leitlinie für Data-Science-Projekte,
in denen Entscheidungsverantwortung und operative Umsetzung klar getrennt sein müssen \cite{ISACA2018}.
