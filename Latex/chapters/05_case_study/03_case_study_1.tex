...
Risikoakzeptanz) und einen Eskalationspfad für Zielkonflikte (Tab.~\hyperref[tab:cs1_phase1_massnahmen]{\ref{tab:cs1_phase1_massnahmen}}).
...
Data Science und Compliance bewertet (Tab.~\hyperref[tab:cs1_phase2_massnahmen]{\ref{tab:cs1_phase2_massnahmen}}).
...
und Mindestkriterien je Segment; Grenzfälle werden manuell geprüft (Tab.~\hyperref[tab:cs1_phase3_massnahmen]{\ref{tab:cs1_phase3_massnahmen}}).
...
werden verbindlich festgelegt (Tab.~\hyperref[tab:cs1_phase4_massnahmen]{\ref{tab:cs1_phase4_massnahmen}}).
