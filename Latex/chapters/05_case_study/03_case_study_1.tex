...
Da ein KI-gestütztes Kreditscoring nach dem EU AI Act als Hochrisikosystem eingestuft wird \cite{EUAIAct2024},
...
Die Freigabe setzt voraus, dass keine offenen Freigabepunkte verbleiben und die Dokumentationsvollständigkeit der Ziel- und Rollenfestlegung 100\% erreicht.
...
\begin{itemize}
  ...
  \item \textbf{Auswirkung (10):} Eine verzerrte Datengrundlage schwächt das Modell fundamental und kann systematische Fehlentscheidungen mit finanziellen und reputativen Schäden erzeugen (vgl. \hyperref[sec:methode1]{Kapitel~3.1}).
...
Überwacht werden die Pflichtfeldvollständigkeit der Trainingsdaten (Soll: mindestens 98\%) sowie die Differenz der Ablehnungsquoten zwischen Postleitzahlen-Clustern (Soll: maximal 5\%); Great-Expectations-Checks und statistische Verteilungsprüfungen operationalisieren die Entdeckbarkeit.
...
(vgl. \hyperref[sec:methode1]{Kapitel~3.1}):
...
Da der EU AI Act automatisierte Kreditentscheidungen als hochriskant einstuft \cite{EUAIAct2024},
...
\paragraph*{Maßnahmen.}
Steuerung über Robustheits-/Sensitivitätsanalysen, Erklärbarkeit (z.B. SHAP \cite{lundberg_unified_2017}/LIME \cite{ribeiro_why_2016})
und Mindestkriterien je Segment; Grenzfälle werden manuell geprüft (Tab.~\ref{tab:cs1_phase3_massnahmen}).
Als Mindestkriterien werden eine Segment-AUC von mindestens 0{,}75 sowie ein maximaler Performance-Gap zwischen Segmenten von 0{,}05 überwacht.
...
Erklärbarkeit & SHAP \cite{lundberg_unified_2017}/LIME \cite{ribeiro_why_2016}-Analysen zur Identifikation riskanter Muster und Proxy-Effekte. \\
...
eine formale interne Abnahme durch Compliance und Risikomanagement bestehen \cite{EUAIAct2024},
...
Überwacht wird der Population Stability Index (PSI), der unter 0{,}20 als unkritisch gilt; die Schnittstellenfehlerquote muss unter 1\% bleiben.
...
Der Alarmwert liegt bei einem PSI über 0{,}25; die Reaktionszeit auf Incidents wird auf maximal 30 Minuten begrenzt.
