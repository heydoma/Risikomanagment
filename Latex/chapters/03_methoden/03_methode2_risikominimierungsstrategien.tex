...
die Interpretierbarkeit von Modellen verbessern (SHAP). Darüber hinaus kann das Deployment von Modellen bei Überschreitung definierter Schwellenwerte automatisiert verhindert werden (vgl. McKinsey).
