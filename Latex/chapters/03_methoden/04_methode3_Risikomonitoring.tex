\section{Prozessschritt 3: Risikomonitoring und Risikoreporting} \label{sec:risiko_monitoring}
...
Für das Monitoring in Data-Science-Projekten sind typischerweise vier Signalgruppen relevant \cite{Sculley2015,Amershi2019}:
\begin{itemize}
  \item \textbf{Daten- und Labelqualität:}
        Verteilungsshifts, Schemaänderungen, fehlende Werte sowie Inkonsistenzen
        zwischen Trainingsdaten und Produktionsdaten.
  \item \textbf{Modellgüte und Robustheit:}
        Abfall in Accuracy, F1 oder AUC, erhöhte Fehlerquoten in kritischen Klassen
        sowie Performanceunterschiede zwischen Gruppen.
  \item \textbf{Betrieb und Sicherheit:}
        Latenzen, Ausfallraten und Änderungen an Datenpipelines oder Modellversionen.
  \item \textbf{Businesswirkung:}
        Nutzenkennzahlen wie Kosten oder Durchlaufzeiten sowie Anzeichen für
        Fehlsteuerung durch falsche Modellinterpretation im Geschäftsprozess.
\end{itemize}
...
\begin{itemize}
  ...
  \item ein \textbf{aktualisiertes Risikoregister} mit Maßnahmenstatus und Entscheidungen
